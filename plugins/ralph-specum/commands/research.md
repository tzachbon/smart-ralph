...
2. **If installed**: Run `mdview ./specs/$spec/research.md` using Bash to render the document beautifully in the terminal
3. **If NOT installed**: Display this recommendation:
   ...
   Then view with: mdview ./specs/$spec/research.md
   ```
