...
<!-- Skills field is REQUIRED on every VE task. task-planner must populate {{platform_skills}} from discovered skills. -->

- [ ] VE0 [VERIFY] Build selector map (ui-map-init)
  - **Skills**: e2e, playwright-env, mcp-playwright, ui-map-init{{#if platform_skills}}, {{platform_skills}}{{/if}}
...
- [ ] VE1 [VERIFY] E2E startup: launch dev server and verify health
  - **Skills**: e2e, playwright-env, mcp-playwright, playwright-session{{#if platform_skills}}, {{platform_skills}}{{/if}}
  - **Do**:
