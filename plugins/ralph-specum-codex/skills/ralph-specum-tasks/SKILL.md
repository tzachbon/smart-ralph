...
3. In interactive mode, require artifact approval for the current `design.md` before starting tasks. Exact quick mode continues with the validated artifact.
...
6. Ensure skill discovery pass 2 exists for the goal plus final research. Run it now when the state lacks an applicable revision. Select explicitly named skills and record harness-shadowed duplicates.
