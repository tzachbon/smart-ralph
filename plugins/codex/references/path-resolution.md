...
```bash
python3 ./plugins/codex/scripts/resolve_spec_paths.py --cwd "$PWD"
python3 ./plugins/codex/scripts/resolve_spec_paths.py --cwd "$PWD" --current
python3 ./plugins/codex/scripts/resolve_spec_paths.py --cwd "$PWD" --name api-auth
python3 ./plugins/codex/scripts/resolve_spec_paths.py --cwd "$PWD" --list
```
