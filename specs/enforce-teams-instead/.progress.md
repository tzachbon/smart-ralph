...
- [x] 4.1 Bump plugin version - bumped 3.4.1 -> 3.5.0 in both plugin.json and marketplace.json
- [x] 4.2 Create PR and verify - PR #93 created at https://github.com/tzachbon/smart-ralph/pull/93
