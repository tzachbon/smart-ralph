...
- [x] 3.1 Set up bats-core test infrastructure - (tests/helpers/setup.bash, tests/fixtures/)
- [x] 3.2 Add stop-hook unit tests - (tests/stop-hook.bats, 14 tests)
- [x] 3.3 Add state management tests - (tests/state-management.bats, 25 tests)
- [x] 4.1 Bump version to 3.0.0 - 7e4b65a
