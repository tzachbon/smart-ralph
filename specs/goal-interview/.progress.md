...
Task 1.2: Remove tools field from remaining 4 agents
...
Task 1.2: Remove tools field from remaining 4 agents (product-manager, architect-reviewer, task-planner, plan-synthesizer)
