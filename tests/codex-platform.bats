...
files = {
    ...
    "plugins/ralph-specum-codex/README.md": ["grill-with-docs", "prototype"],
    "plugins/ralph-specum-codex/skills/ralph-specum/SKILL.md": ["grill-with-docs"],
    "plugins/ralph-specum-codex/skills/ralph-specum-start/SKILL.md": ["grill-with-docs"],
    "plugins/ralph-specum-codex/skills/ralph-specum-research/SKILL.md": ["grill-with-docs", "run review agent", "run prototype", "request changes", "continue to requirements"],
    "plugins/ralph-specum-codex/skills/ralph-specum-requirements/SKILL.md": ["grill-with-docs", "run review agent", "run prototype", "request changes", "continue to design"],
    "plugins/ralph-specum-codex/skills/ralph-specum-design/SKILL.md": ["grill-with-docs", "run review agent", "run prototype", "request changes", "continue to tasks"],
    "plugins/ralph-specum-codex/skills/ralph-specum-tasks/SKILL.md": ["grill-with-docs", "run review agent", "request changes", "continue to implementation"],
    "plugins/ralph-specum-codex/assets/bootstrap/AGENTS.md": ["grill-with-docs", "prototype"],
}
