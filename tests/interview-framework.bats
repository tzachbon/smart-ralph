...
@test "plugin.json version is 5.0.0" {
    grep -q '"version": "5.0.0"' "plugins/ralph-specum/.claude-plugin/plugin.json"
}

@test "marketplace.json ralph-specum version is 5.0.0" {
